...
(function(a) {
    ...
    pc.DDDD = h(pc.DDD, 3), m(j.prototype, {
        ...
        _months: "January_February_March_April_Maio_June_July_August_September_October_November_December".split("_"),
        months: function(a) {
    ...
    tb.normalizeUnits = function(a) {
        ...
        toString: function() {
            return this.clone().locale("en").format("YYYY-MM-DD"); //Modifica aqui
        },
        toDate: function() {
