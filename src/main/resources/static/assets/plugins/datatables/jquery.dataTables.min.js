...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Início",sLast:"Final",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Não - registros na tabela",sInfo:"Mostrando _START_ - _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 há 0 de 0 registros",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sSearch:"",sSearchPlaceholder:"Procurar...",sUrl:"",sZeroRecords:"Não há registros"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
